...
function initIslandsMap() {
  ...
  if (!el) return;
  cvfLang = el.getAttribute("data-lang") === "en" ? "en" : "ja";
...
function openIslandInfo(isl, marker) {
  ...
  var openLabel = (cvfLang === "en") ? "Open in Google Maps" : "Googleマップで開く";
  var detailLabel = (cvfLang === "en") ? "Island guide" : "この島のガイド";
...
window.gm_authFailure = function () {
  ...
  var msg = (document.documentElement.lang === "en")
    ...
    : '地図を読み込めませんでした。<a href="https://www.google.com/maps/search/?api=1&query=Cape+Verde" target="_blank" rel="noopener">Googleマップでカーボベルデを開く &#8599;</a>';
